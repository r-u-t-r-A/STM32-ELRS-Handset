...
STRUCT_MENUPOS ELRS_menu[6];

STRUCT_MENUPOS TRIM_menu[4];

STRUCT_MENUPOS NRF24_menu[4];

STRUCT_MENUPOS vtx_menu[4];

STRUCT_MENUPOS misc_menu[4];
...
uint8_t elrs_tx_pkt_rate[9] =                    {0x00,     0x01,         0x02,     0x03,         0x04,         0x05,    0x06,   0x07,   0x08   };
#ifdef SCHOOL
  const char* elrs_tx_pkt_rate_labels_2400[9] =    {"50Hz  ", "100Hz Full", "150Hz ", "250Hz",      "333Hz full", "500Hz", "D250", "D500", "F500" };
  const char* elrs_tx_pkt_rate_labels_868[9]  =    {"25Hz  ", "50Hz ",      "100Hz" , "100Hz full", "200hz",      "MAX",   "MAX" , "MAX" , "MAX"  };
#endif

#ifndef SCHOOL
  const char* elrs_tx_pkt_rate_labels_2400[9] =    {"50Hz  ", "100Hz Full", "150Hz ", "250Hz",      "333Hz full", "500Hz", "D250", "D500", "F500" };
  const char* elrs_tx_pkt_rate_labels_868[9]  =    {"25Hz  ", "50Hz ",      "100Hz" , "100Hz full", "200hz",      "MAX",   "MAX" , "MAX" , "KYS"  };
#endif
const char* elrs_tx_pkt_rate_labels_default[9] = {"0x00",   "0x01",       "0x02",   "0x03",       "0x04",       "0x05",  "0x06", "0x07", "0x08" };
